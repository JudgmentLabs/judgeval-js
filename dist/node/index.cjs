...
function installOtelContextBridge(getCurrentJudgmentContext) {
  ...
  api.active = () => {
    ...
    if (bridged)
      return bridged;
    return getJudgmentContext ? getJudgmentContext() : import_api.ROOT_CONTEXT;
  };
...
var import_api, import_async_hooks, installed = false, getJudgmentContext = null, gateStorage, bridgeContextStorage, originalActive, originalWith, originalBind;
var init_OtelContextBridge = __esm(() => {
  import_api = require("@opentelemetry/api");
  import_async_hooks = require("async_hooks");
  gateStorage = new import_async_hooks.AsyncLocalStorage;
  bridgeContextStorage = new import_async_hooks.AsyncLocalStorage;
  originalActive = import_api.context.active.bind(import_api.context);
  originalWith = import_api.context.with.bind(import_api.context);
  originalBind = import_api.context.bind.bind(import_api.context);
});
...
var import_api2, noOpTracer, noOpRuntime, runtime = null, llmWrapper = null;
var init_runtime = __esm(() => {
  ...
  noOpRuntime = {
    ...
    setSpan(ctx, span) {
      return import_api2.trace.setSpan(ctx, span);
    },
    wrapSpanContext(spanContext) {
      return import_api2.trace.wrapSpanContext(spanContext);
    },
    getCurrentSpan() {
      return;
    },
...
class JudgmentTracerProvider {
  ...
  static installAsGlobalTracerProvider() {
    ...
    return import_api3.trace.setGlobalTracerProvider(instance);
  }
  register(tracer) {
  ...
  setActive(tracer) {
    ...
    if (currentSpan?.isRecording()) {
      if (import_api3.trace.getSpan(this.getCurrentContext()) === currentSpan) {
  ...
  getCurrentContext() {
    return _contextStorage.getStore() ?? import_api3.ROOT_CONTEXT;
  }
  setSpan(ctx, span) {
    return import_api3.trace.setSpan(ctx, span);
  }
  wrapSpanContext(spanContext) {
    return import_api3.trace.wrapSpanContext(spanContext);
  }
  getCurrentSpan() {
    const ctx = this.getCurrentContext();
    return import_api3.trace.getSpan(ctx);
  }
  hasActiveRootSpan() {
    const currentSpan = this.getCurrentSpan();
    if (!currentSpan?.isRecording())
  ...
  useSpan(span, endOnExit, recordException, setStatusOnException, fn) {
    ...
    const ctx = import_api3.trace.setSpan(prevCtx, span);
...
var import_api3, import_instrumentation, import_async_hooks2, TRACER_NAME = "judgeval", _contextStorage;
var init_JudgmentTracerProvider = __esm(() => {
  ...
  _contextStorage = new import_async_hooks2.AsyncLocalStorage;
});
...
class JudgmentBaggagePropagator {
  inject(context, carrier, setter) {
    ...
    if (!baggage || import_core.isTracingSuppressed(context))
      return;
...
__export(exports_baggage, {
  ...
  baggageEntryMetadataFromString: () => import_api6.baggageEntryMetadataFromString,
...
var import_api5, import_api6, createBaggage, BAGGAGE_KEY;
var init_baggage = __esm(() => {
  ...
  createBaggage = import_api5.propagation.createBaggage.bind(import_api5.propagation);
  BAGGAGE_KEY = import_api5.createContextKey("baggage");
});
...
var init_propagation = __esm(() => {
  ...
  _globalTextmap = new import_core2.CompositePropagator({
    propagators: [
      new import_core2.W3CTraceContextPropagator,
...
class BaseTracer {
      ...
      try {
        ...
        if (result instanceof Promise) {
          return result.catch((e) => {
            span.setStatus({ code: import_api8.SpanStatusCode.ERROR, message: String(e) });
    ...
    const decorator = (innerFunc) => {
      ...
      return function(...args) {
        ...
        if (shouldFork) {
          ...
          const parentlessCtx = proxy.setSpan(proxy.getCurrentContext(), proxy.wrapSpanContext(import_api8.INVALID_SPAN_CONTEXT));
  ...
  static setError(error, span) {
    dontThrow("BaseTracer.setError", () => {
      ...
      target.setStatus({ code: import_api8.SpanStatusCode.ERROR, message: String(error) });
    });
  }
...
var import_api8, TRACER_NAME2 = "judgeval";
...
class JudgmentSpanExporter {
  ...
  constructor(endpoint, apiKey, organizationId, projectId) {
    ...
    this._delegate = new import_exporter_trace_otlp_http.OTLPTraceExporter({
      url: endpoint,
      headers: {
...
var import_core3, NoOpSpanExporter;
...
var import_sdk_trace_base, JudgmentSpanProcessor;
var init_JudgmentSpanProcessor = __esm(() => {
  ...
  JudgmentSpanProcessor = class JudgmentSpanProcessor extends import_sdk_trace_base.BatchSpanProcessor {
    tracer;
    _state = new Map;
    _spanFinalizers;
    _baggageProcessor;
...
// src/trace/Tracer.ts
var import_resources, import_sdk_trace_node, Tracer;
var init_Tracer = __esm(() => {
  ...
  Tracer = class Tracer extends BaseTracer {
    ...
    static async init(config = {}) {
      ...
      const resource = import_resources.defaultResource().merge(import_resources.resourceFromAttributes(resourceAttrs));
      ...
      if (enableMonitoring) {
        const providerWithProcessor = new import_sdk_trace_node.NodeTracerProvider({
          resource,
          sampler: config.sampler,
          spanLimits: config.spanLimits,
          spanProcessors: [
...
var import_resources2, import_sdk_trace_node2, OFFLINE_TRACES_PATH = "otel/v1/offline-traces", OfflineTracer;
var init_OfflineTracer = __esm(() => {
  ...
  import_resources2 = require("@opentelemetry/resources");
  import_sdk_trace_node2 = require("@opentelemetry/sdk-trace-node");
  OfflineTracer = class OfflineTracer extends Tracer {
    ...
    static async create(config) {
      ...
      const resource = import_resources2.defaultResource().merge(import_resources2.resourceFromAttributes(resourceAttrs));
      const tracer = new OfflineTracer({
        ...
        serializer,
        tracerProvider: new import_sdk_trace_node2.NodeTracerProvider({ resource }),
        client: client2,
        dataset: config.dataset,
        exampleFields: { ...config.exampleFields ?? {} }
      });
      const providerWithProcessor = new import_sdk_trace_node2.NodeTracerProvider({
        resource,
        sampler: config.sampler,
        spanLimits: config.spanLimits,
        spanProcessors: [
...
__export(exports_node, {
  ...
  wrap: () => wrap,
  propagation: () => exports_propagation,
  baggage: () => exports_baggage,
  Tracer: () => Tracer,
  OfflineTracer: () => OfflineTracer,
  OfflineJudgmentSpanProcessor: () => OfflineJudgmentSpanProcessor,
  NoOpSpanProcessor: () => NoOpSpanProcessor,
  NoOpSpanExporter: () => NoOpSpanExporter,
  JudgmentTracerProvider: () => JudgmentTracerProvider,
  JudgmentSpanExporter: () => JudgmentSpanExporter,
  JudgmentBaggageSpanProcessor: () => JudgmentBaggageSpanProcessor,
  JudgmentBaggagePropagator: () => JudgmentBaggagePropagator,
  Judgeval: () => Judgeval,
  Judge: () => Judge,
  Example: () => Example,
  ...
  AgentJudgeFactory: () => AgentJudgeFactory,
  ALLOW_ALL_BAGGAGE_KEYS: () => ALLOW_ALL_BAGGAGE_KEYS
});
...
//# debugId=BD3C4C93885D239464756E2164756E21
//# sourceMappingURL=data:application/json;base64,
